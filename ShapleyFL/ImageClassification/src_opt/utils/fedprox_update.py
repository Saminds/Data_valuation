...
class LocalUpdate(object):
    ...
    def train_val_test(self, dataset, idxs):
        ...
        #print("samin kale pache", int(len(idxs_val)/10), "\n dokhtare haji almas")
    ...
    def update_weights(self, model, global_round,global_model,mu):
        ...
        for iter in range(self.args.local_ep):
            ...
            for batch_idx, (images, labels) in enumerate(self.trainloader):
                ...
                loss = self.criterion(log_probs, labels)+mu/2*proximal_term
                loss.backward()
                optimizer.step()
                '''
