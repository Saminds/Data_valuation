...
from src_opt.utils.fedprox_update import LocalUpdate, test_inference
...
args = args_parser()
exp_details(args)
print("Global Batch size (bs):", args.bs)
...
def solver():
    ...
    print("user_group", user_groups[0])
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for idx in idxs_users:
            ...
            w, loss = local_model.update_weights(
                model=copy.deepcopy(global_model), global_round=epoch, global_model=global_model, mu=1)
        ...
        #     global_weights = avgSV_weights(local_weights, shapley, original_weights, 0.1, epoch)
...
if __name__ == '__main__':
    ...
    for _ in range(repeat):
        ...
        train_acc += train
        # show_avg(acc_list)
        path = '../save_opt/{}/FedProx_{}_cnn_E{}_N{}_repeat{}_{}.txt'.format(NoiseWord[noise], args.dataset, args.epochs,  args.noiselevel, repeat, args.device)
        f = open(path, "a+")
